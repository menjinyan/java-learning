...
### 面向对象的三大特征:
![img_1.png](img_1.png)
什么是封装:![img_2.png](img_2.png) 有了封装之后就可以把整体的对象传递给方法
什么是继承:![img_3.png](img_3.png)  此图的上面是父类下面是子类，在子类中可以访问父类中非私有的成员，继承也可以解决javabean中代码重复的问题，当然继承也就是多态的前提体条件
什么是多态:![img_4.png](img_4.png)